					...
					<table>
						...
						<form action="changeroomset.action" method="post" >
							<tr>
								...
								<td>${room.occupy}</td>
								<td>${surplusGoods}</td>
								<td><input type="text" class="xx" value="${room.classify}"
									style="text-align: center;" name="classify"/></td>
								<td><input type="text" class="xx" value="${room.content1}"
									style="text-align: center;" name="content1"/></td>
								<td><input type="text" class="xx" value="${room.content2}"
									style="text-align: center;" name="content2"/>
								</td>
								<td><input type="text" class="xx" value="${room.content3}"
