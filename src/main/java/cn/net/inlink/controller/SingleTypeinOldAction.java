...
@Controller
@Scope("prototype")
public class SingleTypeinOldAction {

	// 日志
	private Logger log = Logger.getLogger(SingleTypeinOldAction.class);
	...
	public String execute() {
		...
		//log.info(buildingName+" |"+roomCode+" |"+empCode+" |"+bedNum+" |"+wardrobeNum+" |"+deskNum+" |"+shoeboxNum+" "+" "+mattressNum+" |"+empGender+" |"+livingDate+" |"+dept+" |"+duty);
