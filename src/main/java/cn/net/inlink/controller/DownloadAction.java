...
public class DownloadAction {
	...
	public InputStream getInputStream() throws UnsupportedEncodingException,
		...
		log.info(ServletActionContext.getServletContext().getRealPath("/"+"excel/退宿人员信息.xls"));
		
		return new FileInputStream(ServletActionContext.getServletContext().getRealPath("/"+"excel/退宿人员信息.xls"));
		// 如果fileName是绝对路径
